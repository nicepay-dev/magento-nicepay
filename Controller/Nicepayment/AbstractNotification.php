...
abstract class AbstractNotification extends Action implements CsrfAwareActionInterface
{
    ...
    public function createCsrfValidationException(
        ...
        $result->setHttpResponseCode(403)
            ->setData(['error' => 'Invalid CSRF token']);
    ...
    {
        return $this->securityHelper->validateNotificationRequest($request);
    }

    // Common validation for all notifications
    protected function validateRequest(RequestInterface $request): bool
    {
        ...
        // return $this->securityHelper->verifySignature(
        //     $request->getContent(),
