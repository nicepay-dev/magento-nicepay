...
class CommonHelper extends AbstractHelper
{
    ...
    public static function getNicepayPaymentCode($paymentMethod)
    {
        $nicepayPaymentCode = "";
        switch ($paymentMethod) {
            case '00':
                $nicepayPaymentCode = 'redirect';
                break;
            case '01':
                $nicepayPaymentCode = 'card';
                break;
            case '02':
                $nicepayPaymentCode = 'virtual_account';
                break;
            case '03':
                $nicepayPaymentCode = 'cvs';
                break;
            case '04':
                $nicepayPaymentCode = 'directdebit';
                break;
            case '05':
                $nicepayPaymentCode = 'ewallet';
                break;
            case '06':
                $nicepayPaymentCode = 'payloan';
                break;
            case '07':
                $nicepayPaymentCode = 'payout';
                break;
            case '08':
                $nicepayPaymentCode = 'qris';
                break;
            case '09':
                $nicepayPaymentCode = 'gpn';
                break;
        }

        return $nicepayPaymentCode;
    }
