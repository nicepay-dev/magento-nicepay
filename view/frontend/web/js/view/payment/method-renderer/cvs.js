define([
    ...
    return Component.extend({
        ...
        getDescription: function () {
            return window.checkoutConfig.payment.cvs.description;
        },

        getTestDescription: function () {
            return {
                prefix: "Note: ",
                content: "Convenience Store Payment sandbox environment",
            };
        },
        ...
        afterPlaceOrder: function () {
            ...
            var redirectUrl = url.build(
                "nicepay/nicepayment/registration?payMethod=03&mitraCd=" + mitra
            );
        ...
        validate: function () {
            ...
            if (this.getCode() === "cvs" && !this.selectedMitra()) {
